with base_population as (
    ...
    and prod_desc = 'SPL' and cast(tenor as numeric) = 24
...
, tracker as (
    select 
        ...
        , max(case when B.ecl_bucket = 5 then 1 else 0 end) over (partition by A.pt_date, A.prod_code, A.prod_desc, A.tenor, A.int_real_rate, A.condition, A.ec_number, A.ecl_bucket order by A.pt_date, B.pt_date rows unbounded preceding) as mt_ever_default_flag
...
, cohort_odr as (
    ...
    , a.mt_count_loan / a.mt_count_loan as marginal_odr_loan
    , a.mt_count_client / a.mt_count_client as marginal_odr_client
    , a.mt_cur_balance / a.mt_cur_balance marginal_odr_cur_balance
    , (a.mt_count_loan - lag(a.mt_count_loan, 1,0) over(partition by ec_number, tenor, pd_segment, ecl_bucket, count_loan, count_client, cur_balance, pt_date order by pt_date, pd_segment, tenor, mt_date, period asc)) / a.mt_count_loan as cumulative_odr_loan
    , (a.mt_count_client - lag(a.mt_count_client, 1,0) over(partition by ec_number,tenor, pd_segment, ecl_bucket, count_loan, count_client, cur_balance, pt_date order by pt_date, pd_segment, tenor, mt_date, period asc)) / a.mt_count_client as cumulative_odr_client
    , (a.mt_cur_balance - lag(a.mt_cur_balance, 1,0) over(partition by ec_number,tenor, pd_segment, ecl_bucket, count_loan, count_client, cur_balance, pt_date order by pt_date, pd_segment, tenor, mt_date, period asc)) / a.mt_cur_balance as cumulative_odr_cur_balance
    , a.cut_off_date
    , a.pt_date
    from (    
        select 
        ...
        on b.snapshot_date >= a.mt_date
        and b.snapshot_date = a.pt_date
        -- and a.prod_code = b.prod_code 
        and a.prod_desc = b.prod_desc 
        and a.tenor = b.tenor 
        -- and a.int_real_rate = b.int_real_rate 
